...
void CtpTD::reqAuthenticate()
{
    ...
    strncpy_s(a.BrokerID, broker_id_.c_str(), sizeof(TThostFtdcBrokerIDType));
    strncpy_s(a.UserID, account_id_.c_str(), sizeof(TThostFtdcUserIDType));
    strncpy_s(a.AuthCode, auth_code_.c_str(), sizeof(TThostFtdcAuthCodeType));
    strncpy_s(a.AppID, app_id_.c_str(), sizeof(TThostFtdcAppIDType));
...
void CtpTD::reqUserlogin()
{
    ...
    strcpy_s(Loginfield.BrokerID, broker_id_.c_str());
    strcpy_s(Loginfield.UserID, account_id_.c_str());
    strcpy_s(Loginfield.Password, password_.c_str());
...
void CtpTD::setOrderInfo(CThostFtdcRspUserLoginField* pRspUserLogin)
{
    ...
    strcpy_s(m_orderActionReq.BrokerID, broker_id_.c_str());
    strcpy_s(m_orderActionReq.InvestorID, account_id_.c_str());
    ...
    strcpy_s(m_positionReq.BrokerID, broker_id_.c_str());
    strcpy_s(m_positionReq.InvestorID, account_id_.c_str());
    memset(&m_orderInsertReq, 0, sizeof(m_orderInsertReq));
    strcpy_s(m_orderInsertReq.BrokerID, broker_id_.c_str());
    strcpy_s(m_orderInsertReq.InvestorID, account_id_.c_str());
...
void CtpTD::reqSettlementInfoConfirm()
{
    ...
    strcpy_s(pSettlementInfoConfirm.BrokerID, broker_id_.c_str());
    strcpy_s(pSettlementInfoConfirm.InvestorID, account_id_.c_str());
...
void CtpTD::reqQueryTradingAccount()
{
    ...
    strcpy_s(tradingAccountReq.BrokerID, broker_id_.c_str());
    strcpy_s(tradingAccountReq.InvestorID, account_id_.c_str());
...
{
    strcpy_s(m_positionReq.InstrumentID, brokerID);
    strcpy_s(m_positionReq.InvestorID, InvestorID);
    std::this_thread::sleep_for(std::chrono::milliseconds(200));
...
{
    strcpy_s(m_orderActionReq.OrderRef, pOrder->OrderRef);
    strcpy_s(m_orderActionReq.InstrumentID, pOrder->InstrumentID);
    strcpy_s(m_orderActionReq.ExchangeID, pOrder->ExchangeID);
...
void CtpTD::reqOrderInsert(Orders_s& orderData)
{
    ...
    //经纪公司代码
    strcpy_s(orderField.BrokerID, broker_id_.c_str());
    //投资者代码
    strcpy_s(orderField.InvestorID, account_id_.c_str());
    std::string strMarket;
    //小写转大写
    transform(orderData.strMarket.begin(), orderData.strMarket.end(), back_inserter(strMarket), ::toupper);
    strcpy_s(orderField.ExchangeID, strMarket.c_str());
    //合约代码
    strcpy_s(orderField.InstrumentID, orderData.strCode.c_str());
    //报单引用
    snprintf(m_orderRef, sizeof(m_orderRef), "%d", m_maxOrderRef++); // order reference is character array
    strcpy_s(orderField.OrderRef, m_orderRef);
    //报单价格条件
    ...
    strcpy_s(pOrder->InstrumentID, orderField.InstrumentID);
    strcpy_s(pOrder->OrderRef, orderField.OrderRef);
    strcpy_s(pOrder->ExchangeID, orderField.ExchangeID);
