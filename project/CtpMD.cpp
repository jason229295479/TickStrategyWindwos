...
void CtpMD::OnRspUserLogout(CThostFtdcUserLogoutField* pUserLogout, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    ...
    strcpy_s(logoutField.BrokerID, broker_id_.c_str());
    strcpy_s(logoutField.UserID, account_id_.c_str());
...
bool CtpMD::login()
{
    ...
    strncpy_s(login_field.TradingDay, "", sizeof(TThostFtdcDateType));
    strncpy_s(login_field.UserID, account_id_.c_str(), sizeof(TThostFtdcUserIDType));
    strncpy_s(login_field.BrokerID, broker_id_.c_str(), sizeof(TThostFtdcBrokerIDType));
    strncpy_s(login_field.Password, password_.c_str(), sizeof(sizeof(TThostFtdcPasswordType)));
